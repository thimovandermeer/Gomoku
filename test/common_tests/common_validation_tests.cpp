...
TEST(double_three_check_tests, check_double_three_with_open_space_not_free_right_horizontal) {
    Coordinate boundary_coords{10, 10};
    Coordinate new_coords{10, 12};
